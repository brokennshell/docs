        ...
        >
            <div className="container-docs flex items-center justify-between h-16">
                <Link href="/" className="flex items-center gap-2.5 group">
                    <div className="w-8 h-8 rounded-lg bg-accent-primary/10 border border-accent-primary/20 flex items-center justify-center transition-colors group-hover:bg-accent-primary/20">
                        <svg
                            width="16"
                            height="16"
                            viewBox="0 0 24 24"
